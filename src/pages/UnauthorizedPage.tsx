  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-6 dark:bg-gray-950">
      <div className="text-center animate-fade-in">
        {/* Shield icon */}
        <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-3xl bg-linear-to-br from-amber-100 to-orange-200 dark:from-amber-900/30 dark:to-orange-900/30">
          <svg
